...
void setup()
 {
	...
	else Serial.println(">> BME280 temp sensor init");
    ...
    else Serial.println(">> VEML6075 UV sensor init");
	...
	psensor_data->wind_dir = 0.0;
	psensor_data->wind_speed = 0.0;
...
void sample_uv(void)
{
	...
	if(psensor_data->uv_index < 0.0)
		psensor_data->uv_index = 0.0;
